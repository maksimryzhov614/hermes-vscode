...
![Превью интерфейса Hermes Agent](docs/assets/hermes-panel.png)

_Превью создано из настоящего webview расширения на синтетических данных._
...
├── .github/workflows/
│   ├── ci.yml                проверка push / pull request
│   └── release.yml           точный тег → сборка → Release с .vsix
├── docs/assets/              сгенерированное превью интерфейса
├── media/icon.svg
├── package.json
